...
public class Help {
    ...
    final static String API_LEY = "SNCYlHR4BNENNAqwT0V8ijdU";
    final static String SECRET_KEY = "ephURgSvBiBISOWDMObrqbQA7G6qcGBN";
    final static String url = "https://aip.baidubce.com/oauth/2.0/token";
    final static String token = "24.5ac939543a752c0c1733c760e9b80c22.2592000.1680675599.282335-30764263";
    public static String getToken() throws IOException {
        MediaType mediaType = MediaType.parse("application/json");
        RequestBody body = RequestBody.create(mediaType, "");
        Request request = new Request.Builder()
                .url("https://aip.baidubce.com/oauth/2.0/token?client_id=SNCYlHR4BNENNAqwT0V8ijdU&client_secret=ephURgSvBiBISOWDMObrqbQA7G6qcGBN&grant_type=client_credentials")
                .method("POST", body)
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream stream = new FileInputStream("C:\\Users\\89339\\Desktop\\1.xlsx");
        XSSFWorkbook xssfWorkbook = new XSSFWorkbook(stream);
        XSSFSheet sheetAt = xssfWorkbook.getSheetAt(0);
        String ppp = "https://aip.baidubce.com/rpc/2.0/nlp/v1/topic?charset=UTF-8&access_token=";
        int lastRowNum = sheetAt.getLastRowNum();
        for (int i=1;i<=100;i++){
            XSSFCell cell = sheetAt.getRow(i).getCell(1);
            ...
            String response = doPost(url, body, 10000);
    ...
    public static String doPost(String url, String data, int timeout) {
        ...
        httpPost.addHeader(new BasicHeader("user-agent",strings[random.nextInt(size)-1]));
