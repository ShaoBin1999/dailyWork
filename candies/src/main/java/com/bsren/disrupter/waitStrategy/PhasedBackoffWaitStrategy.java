 ...
 */
package com.bsren.disrupter.waitStrategy;
...
public final class PhasedBackoffWaitStrategy implements WaitStrategy
{
    ...
    /**
     * Construct {@link PhasedBackoffWaitStrategy} with fallback to {@link com.lmax.disruptor.BlockingWaitStrategy}
     *
    ...
    /**
     * Construct {@link PhasedBackoffWaitStrategy} with fallback to {@link com.lmax.disruptor.LiteBlockingWaitStrategy}
     *
     * @param spinTimeout The maximum time in to busy spin for.
     * @param yieldTimeout The maximum time in to yield for.
     * @param units Time units used for the timeout values.
